                ...
                <div className="w-full max-w-md mx-3 sm:mx-auto">
                    <div className="bg-white rounded-3xl shadow-xl shadow-orange-100/60 border border-orange-100 overflow-hidden">
                        ...
                        <div className="bg-gradient-to-r from-orange-500 to-orange-600 px-8 py-6">
                            ...
                            <p className="text-orange-100 text-sm mt-1">Tham gia TechMart để mua sắm dễ dàng!</p>
                        </div>

                        {/* Form */}
                        <form onSubmit={handleRegister} className="px-8 py-7 flex flex-col gap-4">
                            {error && (
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <div className={inputClass}>
                                    ...
                                    <button type="button" onClick={() => setShowPassword(!showPassword)}
                                        className="text-gray-400 hover:text-gray-600 transition-colors" aria-label="Hiện/ẩn mật khẩu">
                            ...
                            {/* Confirm */}
                            <div className="flex flex-col gap-1.5">
                                <label className="text-xs font-semibold text-gray-600 uppercase tracking-wider">Nhập lại mật khẩu</label>
                                <div className={inputClass}>
                                    <Lock className="w-4 h-4 text-gray-400 shrink-0" />
                                    <input
                                    ...
                                    <button type="button" onClick={() => setShowConfirm(!showConfirm)}
                                        className="text-gray-400 hover:text-gray-600 transition-colors" aria-label="Hiện/ẩn">
