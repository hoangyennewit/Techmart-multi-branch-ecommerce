    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex flex-col items-center justify-center py-32 gap-6 text-center px-4">
          ...
          <button
            onClick={() => navigate("/")}
            className="flex items-center gap-2 bg-orange-600 hover:bg-orange-700 active:scale-95
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 sticky top-24">
              ...
              <button
                ...
                className="mt-6 w-full bg-orange-600 hover:bg-orange-700 active:scale-95
              ...
              <button
                onClick={() => navigate("/")}
                className="mt-3 w-full text-sm text-gray-400 hover:text-orange-600
