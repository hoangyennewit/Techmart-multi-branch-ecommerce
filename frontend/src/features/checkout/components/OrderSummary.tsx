    ...
    return (
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 sticky top-24">
            ...
            <button
                type="submit"
                form={formId} 
                className="w-full bg-orange-500 hover:bg-orange-600 active:scale-95 text-white font-bold py-4 rounded-2xl text-lg uppercase tracking-wide shadow-lg shadow-orange-200 transition-all duration-150 flex justify-center items-center gap-2"
            >
                Đặt hàng
