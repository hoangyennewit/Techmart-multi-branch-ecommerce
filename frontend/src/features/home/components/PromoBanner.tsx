...
const bgGradients = [
    { bgFrom: "#0B0515", bgTo: "#1A122E" },
    { bgFrom: "#0B0515", bgTo: "#2C1B4D" },
    { bgFrom: "#0B0515", bgTo: "#164E63" },
];
    ...
    return (
        <div className="w-full px-3 sm:px-6 lg:px-12 max-w-screen-xl mx-auto py-3 sm:py-4">
            <Swiper
                ...
                style={{ ["--swiper-pagination-color" as string]: "#22D3EE" }}
            >
                        ...
                        <SwiperSlide key={product.id}>
                            ...
                            >
                                ...
                                <div
                                    ...
                                    style={{
                                        backgroundImage: "radial-gradient(circle at 70% 50%, #22D3EE 0%, transparent 60%)",
                                    }}
                                />
                                ...
                                <div className="relative z-10 flex flex-col gap-1.5 sm:gap-2 text-white px-5 sm:px-10 py-6 sm:py-8 max-w-[55%] sm:max-w-md">
                                    {(product.discount ?? 0) > 0 && (
                                        <span className="inline-block w-fit px-2.5 py-0.5 bg-purple-600 text-white text-[9px] sm:text-[10px] font-bold rounded-full uppercase tracking-widest">
                                    ...
                                    <p className="text-cyan-400 font-semibold text-xs sm:text-base line-clamp-1">
