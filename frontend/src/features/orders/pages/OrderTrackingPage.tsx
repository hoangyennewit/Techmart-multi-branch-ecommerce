      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        {orders.length === 0 ? (
          <div className="bg-white rounded-2xl p-12 text-center shadow-sm border border-gray-100">
            ...
            <Link
              to="/"
              className="inline-block bg-orange-600 text-white font-bold py-3 px-8 rounded-full shadow-lg shadow-orange-200 hover:bg-orange-700 transition-colors"
            >
              Bắt đầu mua sắm
            </Link>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative mb-8 px-4">
                    ...
                    <div
                      className="absolute top-1/2 left-0 h-1 bg-orange-600 -translate-y-1/2 rounded-full z-0 transition-all duration-500"
