    ...
    return (
        <div className="flex flex-col md:flex-row items-center gap-8 mb-8 pb-8 border-b border-gray-100">
            ...
            <div className="flex flex-col items-center justify-center w-full md:w-1/3">
                <span className="text-5xl font-extrabold text-orange-500 mb-2">
                ...
                <div className="flex items-center gap-1 mb-2">
                    {[1, 2, 3, 4, 5].map((star) => (
                        <Star 
                            key={star} 
                            className={`w-6 h-6 ${star <= Math.round(averageRating) ? "fill-orange-400 text-orange-400" : "fill-gray-200 text-gray-200"}`} 
                        />
                    ))}
                </div>
