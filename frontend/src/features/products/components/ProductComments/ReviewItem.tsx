    ...
    return (
        <div className="flex gap-4 py-6 border-b border-gray-100 last:border-0">
            ...
            <div className="flex-shrink-0">
                <div className="w-12 h-12 rounded-full bg-orange-500 flex flex-col items-center justify-center text-white font-bold text-lg shadow-sm border border-orange-200">
                    {avatarLetter}
                </div>
            </div>
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1 mb-3">
                    {[1, 2, 3, 4, 5].map((star) => (
                        <Star 
                            key={star} 
                            className={`w-3.5 h-3.5 ${star <= comment.stars ? "fill-orange-500 text-orange-500" : "fill-gray-200 text-gray-200"}`} 
                        />
                    ))}
                ...
                <div className="mt-4 flex items-center gap-4 text-xs text-gray-400 font-medium">
                    <button className="hover:text-orange-600 transition-colors">Hữu ích</button>
