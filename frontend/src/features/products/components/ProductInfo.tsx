...
export const ProductInfo = ({ product }: Props) => {
  ...
  return (
    <div className="flex flex-col h-full relative">
      ...
      <h1 className="text-3xl lg:text-4xl font-extrabold text-gray-800 pb-4 leading-tight">
        {product.name}
      </h1>
      ...
      {product.colors && product.colors.length > 0 && (
        <div className="mt-6">
          <div className="flex justify-between items-center mb-3">
            <p className="font-bold text-gray-800 text-sm uppercase tracking-wider">
              Màu sắc
            </p>
      ...
      {product.variants && product.variants.length > 0 && (
        <div className="mt-8">
          <p className="font-bold text-gray-800 mb-3 text-sm uppercase tracking-wider">
            Phiên bản
          </p>
          <div className="flex flex-wrap gap-3">
      ...
      <div className="mt-6 pt-6 border-t border-gray-100">
        <div className="flex items-center gap-2 text-sm bg-gray-50 p-3 rounded-xl inline-flex w-full sm:w-auto">
          ...
          {!isOutOfStock ? (
            ...
            <span className="text-red-500 font-bold bg-red-50 px-2 py-0.5 rounded text-xs uppercase">
              Hết hàng
            </span>
          )}
        </div>
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
        <button
          ...
          className={`flex flex-col items-center justify-center py-3.5 rounded-xl shadow-lg transition-all border-none
                         ${
                           isOutOfStock
        ...
        >
          ...
          <span className="text-xs font-medium opacity-90">
            {isOutOfStock ? "Liên hệ sau" : "Giao hàng tận nơi"}
          </span>
        </button>
